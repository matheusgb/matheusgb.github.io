...
Há um tempo cresceu uma vontade em mim de enriquecer o poder de criar software com alguma outra área, e cismei de entrar no caminho da física computacional, mais específicamente [CFD](https://pt.wikipedia.org/wiki/Fluidodin%C3%A2mica_computacional).
...
Entrei em contato com o Engenheiro de Performance da empresa qual trabalho (Ricardo Sanchez), e estamos buscando trabalhar em uma ferramenta juntos. Tenho me forçando a utilizar C a principio pra ter mais contato com baixo nível (ou [médio nível](https://stackoverflow.com/a/2904712), como dizem os chatos 💩).
